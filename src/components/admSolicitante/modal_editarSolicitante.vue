        ...
        solicitanteData: {
            handler() {
                console.log("PROP CHANGED, UPDATE MODAL")
                    ...
                    this.Primer_apellido = this.solicitanteData.apellido.split(" ")[0]
                    this.Segundo_apellido = this.solicitanteData.apellido.split(" ")[1]
                    this.Movil = this.solicitanteData.telefono
                    this.Movil_proveedores = this.solicitanteData.fono_pago_proveedores
                    this.Contacto_proveedores = this.solicitanteData.contacto_pago_proveedores
