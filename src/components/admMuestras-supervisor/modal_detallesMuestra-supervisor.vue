  ...
  <b-modal id="modal-detalle-muestra-supervisor" :title="`Detalles de la muestra ${RUM}`" size="xl" @hidden="onHidden">
    ...
    <div class="p-3">
      <b-col class="col-12">
        ...
        <b-list-group>
          <b-list-group-item v-if="cargandoParametros"
        ...
        <b-list-group horizontal>
          ...
          <b-list-group-item style="width:70%;padding:0px" class="d-flex align-items-center justify-content-center">
            <b-list-group style="width:100%">
              <b-list-group-item v-if="cargandoAnalistas"
                class="d-flex align-items-center justify-content-center lsa-orange-text" style="height:100px">
                <div>
                  <b-spinner class="align-middle"></b-spinner>
                  <strong> Cargando...</strong>
...
-->
        ...
        <b-row style="border-bottom: 1px solid var(--lsa-light-gray);">
          ...
          <b-col class="col-5">
            <b-row>
              ...
              <b-button v-b-modal.modal-cambiar-fecha
                style="padding:2px; background-color: transparent; border:none; aspect-ratio: 1;" class="reactive-button">
    ...
    <b-modal centered id="modal-cambiar-fecha" size="sm">
      ...
      <validation-observer ref="formfecha">
        ...
        <ValidationProvider name="fecha inicio" rules="required" v-slot="validationContext">
          <b-form-datepicker :date-format-options="{ year: 'numeric', month: '2-digit', day: '2-digit' }"
            placeholder="seleccione fecha" :state="getValidationState(validationContext)" v-model="fecha_entrega_nueva"
      ...
      <template #modal-footer>
        <b-button block @click="cambiarFechaEntrega" variant="primary" size="xl" class="float-right reactive-button"
