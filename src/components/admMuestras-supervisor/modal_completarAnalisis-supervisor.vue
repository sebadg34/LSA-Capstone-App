<template>
    <validation-observer ref="form">
        <b-modal centered id="modal-completar-analisis-supervisor" ref="modal" title="Marcar analisis como completado" size="md">

            <template #modal-header="{ close }">
                <!-- Emulate built in modal header close button action -->

                <b-row class="d-flex justify-content-around">
                    <div class="pl-3">Marcar análisis como completado</div>
            ...
            <b-row class="d-flex justify-content-center">
                <b-col class="col-12">
                    ...
                    <div class="d-flex justify-content-center"
                        ...
                        ¿Estás seguro que deseas marcar el análisis como completado?
                    </div>
        ...
        enviarFormulario() {
            ...
            this.$refs.form.validate().then(success => {
                if (!success) {
                    ...
                    this.busy = true;
                    MuestraSupervisorService.completarAnalisis(this.RUM).then((response) => {
                        this.busy = false;
