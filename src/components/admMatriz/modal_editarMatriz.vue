...
export default {
    ...
    mounted() {
      ...
      //this.obtenerParametro();  //Descomentar cuando se reciba de la API.   
    ...
    watch: {
      ...
      matrizData: {
            handler() {               
                ...
                this.Nombre = this.matrizData.nombre_metodologia;
               
                this.objetosSeleccionados = this.matrizData.objetosSeleccionados;                        
