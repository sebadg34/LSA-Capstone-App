<template>
    <validation-observer ref="form">
        <b-modal centered id="modal-agregar-observacion-quimico" ref="modal" title="Agregar orden de compra" size="md">
        ...
        enviarFormulario() {
            ...
            this.$refs.form.validate().then(success => {
                if (!success) {
                    ...
                    this.busy = true;
                    MuestraQuimicoService.crearObservacionMuestra(data).then((response) => {
                        this.busy = false;
